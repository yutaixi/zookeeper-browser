    ...
    function(b, c) { (function() {
            ...
            b = function(a) {
                function b(a, d) { 
                    ...
                    this.options = c({},
                    this.defaultOptions, e, null != d ? d: {}), this.options.forceFallback || !b.isBrowserSupported()) 
                    {
                ...
                b.prototype.defaultOptions = {
                    ...
                    sendingmultiple: i,
                    success: function(a) {
                        if(typeof this.options.afterUploaded === 'function')
                         {
                             this.options.afterUploaded();
                         }
                ...
                b.prototype.init = function() {
                    var a, c, d, e, f, g, h;
                    for (("form" === this.element.tagName ||"FORM" === this.element.tagName) && this.element.setAttribute("enctype", "multipart/form-data"), this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message") && this.element.appendChild(b.createElement('<div class="dz-default dz-message"><span>' + this.options.dictDefaultMessage + "</span></div>")), this.clickableElements.length && (d = function(a) {
                        return function() {
